...
public class Team {
    ...
    public void heroHandler(JSONObject object) throws JSONException {
    ...
    public JSONObject buildingS() throws JSONException {
        final Int i = new Int();
    ...
    public static JSONObject creeps(Team green, Team red) throws JSONException {
        Int i = new Int();
        JSONObject object = new JSONObject();
    ...
    public static JSONObject getHeroes(Team green, Team red) throws JSONException {
        JSONObject object = new JSONObject();
    ...
    public JSONObject getHero() throws JSONException {
        return hero.getJson();
    }
}
